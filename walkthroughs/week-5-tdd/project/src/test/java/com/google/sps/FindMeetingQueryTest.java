...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeBusyAllDay() {
    // Have one optional attendee, but they are busy all day 
  ...
  public void optionalAttendeeOneEvent() {
    // Have one optional attendee, but they have one event in the morning 
  ...
  @Test 
  public void optionalAttendeeJustNotEnough() {
    // Have one optional attendee, but they have an event that would result in a time slot smaller than the requested time if they were included. 
  ...
  @Test 
  public void allAttendeesOptionalWithGaps() {
    // No mandatory attendees, just 2 optional attendees with gaps in their schedule 
  ...
  @Test 
  public void allAttendeesOptionalWithoutGaps() {
    // No mandatory attendees, just 2 optional attendees without gaps in their schedule 
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, DURATION_1_HOUR),
            Arrays.asList(PERSON_A)),
